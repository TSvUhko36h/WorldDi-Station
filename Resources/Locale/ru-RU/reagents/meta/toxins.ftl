...
reagent-desc-toxintrash = Зловонная жижа, эффективно переработанная из отходов. Это идеальное бесотходное превращение металлолома в пищу для воксов, хотя для остальных это смертоносный яд.
reagent-name-hemorrhinol = геморринол
reagent-desc-hemorrhinol = Токсин, вызывающий серьёзное повреждение кровеносных сосудов и быстрое кровотечение.
