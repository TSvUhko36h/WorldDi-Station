...
reagent-name-dexalin-plus-saline = дексалин плюс и салин
...
reagent-desc-arcryox = ? Зловещее голубое криогенное химическое вещество, способное заживлять даже смертельные раны у мёртвых. Однако с трудом стабилизирует пациентов.
reagent-name-warfarin = варфарин
reagent-desc-warfarin = Широко используется как антикоагулянт. Затрудняет свёртывание крови. При передозировке может вызвать внутреннее кровотечение.
