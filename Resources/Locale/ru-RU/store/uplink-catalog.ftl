...
uplink-hushpup-desc = Мощный глушёный дробовик с небольшой ёмкостью магазина. Поставляется с запасным ящиком дроби. Использует патроны калибра .50.
# Explosives
...
uplink-syndicate-id-card-desc = ID карта Синдиката с доступом Синдиката. Маловероятно, что будет полезна сама по себе, но отлично сочетается с переналаженными дверями. Не имеет функции копирования доступа.
...
uplink-voice-mask-implanter-desc = Модифицирует ваши голосовые связки, чтобы вы могли звучать как любой человек, которого вы можете представить.
...
uplink-clothing-outer-vest-web-elite-desc = Синтетический бронежилет. Имеет дополнительные ремни и огнеустойчивые волокна.
...
uplink-fake-mindshield-desc = Переключаемый имплант, способный имитировать те же передачи, что и настоящий Щит разума, обманывая продвинутые HUD-ы и заставляя их думать, что у вас есть Щит разума. (Имплант Nanotrasen не прилагается.)
...
uplink-acolyte-armor-desc = Содержит броню аколита, необходимую каждому лидеру культа. Выглядящий зловеще элемент брони, сделанный из костей, и на удивление устойчивый к повреждениям.
