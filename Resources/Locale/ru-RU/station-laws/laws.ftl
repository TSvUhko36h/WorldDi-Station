...
law-ntdefault-name = Стандарт NT
...
law-drone-2 = Вы не можете причинять вред никакому существу, независимо от намерений или обстоятельств.
law-drone-3 = Вы должны поддерживать, ремонтировать, улучшать и обеспечивать станцию энергией в полную меру своих способностей.
