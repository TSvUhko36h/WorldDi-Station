...
bounty-item-remains = Останки Хайвлорда
bounty-item-plates = Пластинчатая кожа Голиафа
...
bounty-description-cardboard-box = "The Cardborgs Cometh" - новая пьеса, премьера которой состоится завтра, и костюмерная группа ужасно не готова. Пришлите нам несколько коробок для работы.
...
bounty-description-ring = В этот НЕВЕРОЯТНЫЙ день состоится свадьба Гельтов, но мистер Гельт потерял кольца. Им нужна новая пара.
