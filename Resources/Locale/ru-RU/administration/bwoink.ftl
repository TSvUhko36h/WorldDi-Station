...
bwoink-system-introductory-message =
    Пожалуйста, подробно опишите проблему, с которой вы столкнулись. Предположим, что администратор игры, который решает проблему, не знает о случившемся из первых рук.
